...
export default class Result {
    ...
    static Error(request: XMLHttpRequest, message: string, errorResultId?: number): Result;
    static Parse(request: XMLHttpRequest, dataString: string, uri: string, debug?: boolean): Result;
    result: number;
    message: string;
    data: ResultData;
